...
@Repository
public class KakaoRedisHashRepositoryImpl implements KakaoRedisHashRepository {
    private RedisTemplate<String, Object> redisTemplate;
    private ObjectMapper objectMapper;

    private HashOperations hashOperations;

    public KakaoRedisHashRepositoryImpl(RedisTemplate<String, Object> redisTemplate, ObjectMapper objectMapper){
    ...
    @Override
    public void save(String key, String rMessageResultId, RKakaoMessageResult rMessageResult) {
    ...
    @Override
    public void update(String key, String rMessageResultId, RKakaoMessageResult rMessageResult) {
