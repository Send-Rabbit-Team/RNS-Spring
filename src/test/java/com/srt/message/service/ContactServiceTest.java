...
//
//        // when
//        Contact contact = PostContactReq.toContactEntity(req,group,member);
//
...
//
//        long contactId = contactRepository.findByPhoneNumber(req.getPhoneNumber()).get().getId();
//
//        // then
//        assertThat(contactId).isEqualTo(contact.getId());
//    }
//}
